...
def _load_0504():
    ...
    path = (
        REPO_ROOT
        / "code/archive/05_candidate_industry_affiliations/0504_classify_other_races.py"
    )
...
def _load_0501():
    ...
    path = (
        REPO_ROOT
        / "code/archive/05_candidate_industry_affiliations/0501_classify_donors_with_keywords.py"
    )
