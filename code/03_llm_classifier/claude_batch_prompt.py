...
code list live from `03_inputs/naics_sector_title_expanded_with_custom_codes.csv`
...
CODES_PATH = "03_inputs/naics_sector_title_expanded_with_custom_codes.csv"
...
def build_batch_prompt(units: list[dict]) -> str:
    ...
    `03_outputs/claude_classification_queue.csv` for this batch, as a list of dicts
