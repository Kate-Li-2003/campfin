"""NAICS 2022 reference data: 2-digit sectors and 4-digit industry groups."""

NOT_EMPLOYED_CODE = "0000"
NOT_EMPLOYED_DESC = "Individual - Not Employed"

NOT_EMPLOYED_KEYWORDS = {
    "not employed", "retired", "homemaker", "student", "n/a", "none",
    "unemployed", "housewife", "househusband", "stay at home", "stay-at-home",
    "self-employed", "self employed", "none", "na", "-", "", 
}
...
NAICS_SECTORS = {
    ...
    "92": "Government/Public Safety",

    # manually added sectors
    "100":"Retired/Homemaker/Student/Unemployed",
    "99":"Uncategorized",
    "92a":"Tribes",
    "90":"Candidates/Political Parties",
    "88":"PACs",
    "80":"Other Industries",
    "79":"Technology",
    "77":"Unions",
    "76":"Associations",
    "70":"Entertainment, Media and Gambling",
    "60":"Healthcare/Education",
    "50":"Professional/Legal",
    "40":"Real Estate/Construction",
    "20":"Utilities/Infrastucture"

    # eliminated sectors
    #"22a":"Renewable Energy",
    #"22": "Utilities",
    #"23": "Construction",
    #"42": "Wholesale Trade",
    #"44": "Retail",
    ...
    #"55": "Management and Holding Companies",
    #"56": "Administrative and Support and Waste Management and Remediation Services",
    #"61": "Educational",
    #"62": "Health Care and Social Assistance",
    #"71": "Entertainment, Arts and Recreation",
    #"72": "Food and Lodging",
    #"81": "Other", 
    #"56a":"Administrative and Support",
    #"56b":"Waste Management and Remidiation",
    #"54a":"Lawyers and Law Offices",
    #"51a":"Media",
    #"78":"Defense",
...
NAICS_INDUSTRY_GROUPS = {
    ...
    "5161": "Internet Publishing and Broadcasting and Web Search Portals",
...
ALL_NAICS = {**NAICS_SECTORS, **NAICS_INDUSTRY_GROUPS}

def validate_naics(code: str) -> str:
    """Return validated code, falling back to 2-digit sector or '00' if unknown."""
    code = str(code).strip()
    if code in ALL_NAICS:
        return code
    prefix = code[:2]
    if prefix in NAICS_SECTORS:
        return prefix
    return "00"


'''
def validate_naics(code: str) -> tuple[str, str]:
    """Return (code, description), falling back to 2-digit sector or '00' if unknown."""
    code = str(code).strip()
    if code in ALL_NAICS:
        return code, ALL_NAICS[code]
    # Try 2-digit prefix
    prefix = code[:2]
    if prefix in NAICS_SECTORS:
        return prefix, NAICS_SECTORS[prefix]
    return "00", "Unknown"
'''


def format_naics_reference() -> str:
    """Return a compact NAICS reference string for LLM prompts."""
    lines = ["=== 2-DIGIT SECTORS ==="]
    for code, desc in sorted(NAICS_SECTORS.items()):
        lines.append(f"  {code}: {desc}")
    lines.append("")
    lines.append("=== 4-DIGIT INDUSTRY GROUPS ===")
    current_sector = None
    for code in sorted(NAICS_INDUSTRY_GROUPS):
        sector = code[:2]
        if sector != current_sector:
            current_sector = sector
            lines.append(f"  -- {sector}: {NAICS_SECTORS.get(sector, '')} --")
        lines.append(f"  {code}: {NAICS_INDUSTRY_GROUPS[code]}")
    return "\n".join(lines)
