...
Run once to seed the cache from prior outputs. 

Usage:
    python build_web_search_cache.py
    python build_web_search_cache.py --inputs path1.csv path2.csv
    python build_web_search_cache.py --output 03_outputs/web_search_cache.csv
"""
...
# Files listed later win on duplicate keys 
DEFAULT_INPUTS = [
    "../04_assign_classifications/04_inputs/web_search_output_100_200_v2.csv",
    "../04_assign_classifications/04_inputs/web_search_output_200_400.csv",
    "../04_assign_classifications/04_inputs/web_search_output_400_600.csv",
    "../04_assign_classifications/04_inputs/web_search_output_100_600_1000.csv",
    "../04_assign_classifications/04_inputs/web_search_output_new_rows_071326.csv",
    "../04_assign_classifications/04_inputs/prominent_individual_results_071326.csv",
]

DEFAULT_OUTPUT = "03_outputs/web_search_cache.csv"
