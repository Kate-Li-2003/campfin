"""Python ports of the R standardization functions in 01_contributor_pipeline/standardization_helpers.R.

Used by 0301_web_search.py, its notebook, and build_web_search_cache.py to replicate
...
# ---------------------------------------------------------------------------
# Lighter processing for Gemini search prompts (per the R code in 0301)
