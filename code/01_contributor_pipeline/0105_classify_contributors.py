"""
0105_classify_contributors.py

Classification pipeline for aggregated contributor data.

  Part 0:  Pre-classified direct match
...
Usage
-----
    python 0105_classify_contributors.py
    python 0105_classify_contributors.py --input path/to/classification_input.csv
    python 0105_classify_contributors.py --no-edd   # skip EDD live lookups
"""
...
INPUTS_DIR  = Path(__file__).parent / "01_inputs"
OUTPUTS_DIR = Path(__file__).parent / "01_outputs"
EDD_CACHE_PATH = REPO_ROOT / "code/shared_utils/.edd_naics_cache.json"
...
# same file shared_utils/subcode_resolution.py reads
...
def match_edd(
    ...
    """
    sys.path.insert(0, str(REPO_ROOT / "code" / "shared_utils"))
