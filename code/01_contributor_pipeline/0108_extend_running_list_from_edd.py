"""
0108_extend_running_list_from_edd.py
...
Usage
-----
    python 0108_extend_running_list_from_edd.py
    python 0108_extend_running_list_from_edd.py --dry-run
"""
...
DEFAULT_CLASSIFIED = Path(__file__).parent / "01_outputs" / "classified_contributors.csv"
