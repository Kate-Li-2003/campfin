...
upstream by 01_contributor_pipeline (0102_entity_resolution.Rmd ->
01_outputs/classification_input.csv).

If column names change, update the values below.
"""
...
DEFAULT_INPUT_PATH = str(
    ...
    / "01_contributor_pipeline" / "01_outputs" / "classification_input.csv"
)
